...
import com.breezefieldabhamarketing.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefieldabhamarketing.app.utils.FTStorageUtils
import com.breezefieldabhamarketing.app.utils.NotificationUtils
...
import com.breezefieldabhamarketing.features.addshop.model.AssignedToShopListResponseModel
import com.breezefieldabhamarketing.features.addshop.model.QuestionSubmit
import com.breezefieldabhamarketing.features.addshop.model.UpdateAddrReq
import com.breezefieldabhamarketing.features.addshop.model.UpdateAddressShop
...
import com.breezefieldabhamarketing.features.addshop.presentation.*
...
import com.breezefieldabhamarketing.features.location.model.ShopDurationRequestData
...
import com.breezefieldabhamarketing.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezefieldabhamarketing.features.marketing.model.MarketingCategoryListResponse
...
import com.breezefieldabhamarketing.features.nearbyshops.model.StageListResponseModel
...
import com.breezefieldabhamarketing.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezefieldabhamarketing.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldabhamarketingApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
