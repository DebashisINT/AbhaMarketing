package com.breezefieldabhamarketing.features.commondialogsinglebtn
...
import com.breezefieldabhamarketing.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldabhamarketing.app.domain.VisitRemarksEntity
...
import com.breezefieldabhamarketing.features.addshop.presentation.ProspectListDialog
import com.breezefieldabhamarketing.features.dashboard.presentation.DashboardActivity
import com.breezefieldabhamarketing.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldabhamarketing.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldabhamarketing/files", "recorded_audio${System.currentTimeMillis()}.mp3")
