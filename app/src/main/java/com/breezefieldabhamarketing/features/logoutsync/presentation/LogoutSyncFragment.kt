package com.breezefieldabhamarketing.features.logoutsync.presentation
...
import com.breezefieldabhamarketing.CustomConstants


import com.breezefieldabhamarketing.R
import com.breezefieldabhamarketing.app.AppDatabase
...
import com.breezefieldabhamarketing.app.utils.Toaster
import com.breezefieldabhamarketing.base.BaseResponse
import com.breezefieldabhamarketing.base.presentation.BaseActivity
import com.breezefieldabhamarketing.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldabhamarketing.features.billing.api.AddBillingRepoProvider
import com.breezefieldabhamarketing.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldabhamarketing.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldabhamarketing.features.document.model.AddEditDocumentInputParams
import com.breezefieldabhamarketing.features.document.model.DocumentAttachmentModel
...
import com.breezefieldabhamarketing.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldabhamarketing.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldabhamarketing.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldabhamarketing.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldabhamarketing.features.orderhistory.model.*
...
import com.breezefieldabhamarketing.features.quotation.model.AddQuotInputModel
import com.breezefieldabhamarketing.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldabhamarketing.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldabhamarketing.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldabhamarketing.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldabhamarketing.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldabhamarketing.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldabhamarketing.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldabhamarketing.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldabhamarketing.mappackage.SendBrod
import com.breezefieldabhamarketing.widgets.AppCustomTextView
import com.breezefieldabhamarketing.MonitorService
import com.breezefieldabhamarketing.MySingleton
import com.breezefieldabhamarketing.app.AlarmReceiver
...
import com.breezefieldabhamarketing.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldabhamarketing.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldabhamarketing.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldabhamarketing.features.orderITC.SyncDeleteOpptL
...
import com.breezefieldabhamarketing.features.orderITC.SyncOpptProductL
import com.breezefieldabhamarketing.features.orderITC.SyncOrd
import com.breezefieldabhamarketing.features.orderITC.SyncOrdProductL
import com.breezefieldabhamarketing.features.performance.model.Gps_status_list
import com.breezefieldabhamarketing.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldabhamarketing.features.returnsOrder.ReturnProductList
import com.breezefieldabhamarketing.features.returnsOrder.ReturnRequest
import com.breezefieldabhamarketing.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefieldabhamarketing.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldabhamarketing/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldabhamarketinglogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldabhamarketinglogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldabhamarketinglogsample/log.zip").path);
